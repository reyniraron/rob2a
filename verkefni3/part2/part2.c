...
|*  different, predetermined directions in between to solve a specific problem. The robot can be      *|
|*  stopped using a button on the remote control or on the robot itself.                              *|
|*                                                                                                    *|
\*-----------------------------------------------------------------------------------------------4246-*/
...
// Code moved to header & include files (see above)
/*
task watchForStop() {
	while (true) {
